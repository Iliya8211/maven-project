...
// 12. Validate that the username is correctly displayed on the Profile page
    ...
    public void registerNewUserTest(String username, String email, String password){
        ...
        WebElement registerBtn = driver.findElement(By.cssSelector("a[href='/users/register']"));
        ...
        Assert.assertEquals(actualHeaderText, "Sign up", "Expected header text to be, but got" +
                actualHeaderText);

        System.out.println("4. Enter valid username. Validate that a green check is displayed after entering the value.");
        WebElement usernameField = driver.findElement(By.name("username"));
        //String username = "Auto" + new Random().nextInt(1000);
        ...
        Assert.assertEquals(actualUsername, username, "Username is not correct. Actual username is" + actualUsername);
